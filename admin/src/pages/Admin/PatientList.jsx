...
//       try {
//         setLoading(true);
//         const { data } = await axios.get(`${backendUrl}/api/admin/all-patients?page=${currentPage}&available=${filterStatus}`, {
//           headers: { aToken }
//         });
...
//         const { data: newData } = await axios.get(`${backendUrl}/api/admin/all-patients?page=${currentPage}&status=${filterStatus}`, {
//           headers: { aToken }
//         });
