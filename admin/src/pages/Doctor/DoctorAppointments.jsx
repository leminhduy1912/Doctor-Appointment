...
//                   filterStatus === status ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-600'
//                 } capitalize`}
//               >
//                 {status}
//               </button>
...
//                 <p className='hidden sm:block text-center font-medium'>{startIndex + index + 1}</p>
...
//                 <motion.div className='bg-white rounded-xl p-6 shadow-lg w-96'
//                   initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }}>
//                   {selectedAction.type === 'cancel' ? (
//                     <>
//                       <p className='text-lg font-semibold text-gray-700 mb-2'>Reason for cancellation</p>
//                       <textarea
//                         rows={3}
//                         value={cancelReason}
//                         onChange={(e) => setCancelReason(e.target.value)}
//                         className='w-full border rounded p-2 text-sm text-gray-700 mb-4'
...
//                       className='px-4 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 flex items-center justify-center min-w-[80px]'
//                       disabled={loadingId === selectedAction.id || (selectedAction.type === 'cancel' && !cancelReason.trim())}
//                     >
//                       {loadingId === selectedAction.id ? <ClipLoader size={20} color="#fff" /> : 'Confirm'}
//                     </button>
//                   </div>
//                 </motion.div>
//               </motion.div>
